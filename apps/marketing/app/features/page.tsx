    ...
    <>
      <Section size="sm" className="pt-6 sm:pt-10">
        <PageHero
          ...
          description="One platform for in-store, online, kitchen, delivery, and guest experiences—with your brand on every screen."
        >
