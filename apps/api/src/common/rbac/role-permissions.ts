...
const CATALOG = [
  ...
  'event-bus.replay',
  'event-bus.admin',
  'event-bus.publish.orders',
  'event-bus.publish.inventory',
  'event-bus.publish.customers',
  'event-bus.publish.delivery',
  'event-bus.publish.payments',
  'event-bus.publish.iot',
  'event-bus.read.orders',
  'event-bus.read.inventory',
  'event-bus.read.customers',
  'event-bus.read.delivery',
  'event-bus.read.payments',
  'event-bus.read.iot',
  'globalization.read',
  'globalization.admin',
  'globalization.tax',
