...
export class SearchIndexService {
  ...
  async indexLocation(location: LocationEntity) {
    await this.upsertDocument({
      ...
      title: location.name,
      body: [location.address, location.timezone, location.status, location.locationType].join(' '),
      keywords: [location.name, location.address, location.timezone, location.status, location.locationType],
      metadata: {
