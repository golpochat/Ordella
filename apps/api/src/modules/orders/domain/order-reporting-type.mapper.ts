...
const STATUS_TO_REPORTING: Partial<Record<OrderStatus, OrderReportingEventType>> = {
  ...
  [OrderStatus.PICKING]: OrderReportingEventType.ORDER_PREPARING,
  [OrderStatus.PICKED]: OrderReportingEventType.ORDER_PREPARING,
  [OrderStatus.PREPARING]: OrderReportingEventType.ORDER_PREPARING,
  [OrderStatus.READY]: OrderReportingEventType.ORDER_READY,
  [OrderStatus.HANDED_TO_DRIVER]: OrderReportingEventType.ORDER_OUT_FOR_DELIVERY,
