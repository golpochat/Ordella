...
@Module({
  imports: [AuthModule, TypeOrmModule.forFeature([...TENANTS_ENTITIES, TenantDomainEntity])],
...
export class PlatformModule implements NestModule {
  configure(consumer: MiddlewareConsumer): void {
    consumer
      .apply(SecurityHeadersMiddleware, TenantRoutingMiddleware, RateLimitMiddleware)
      .forRoutes('*');
  }
}
