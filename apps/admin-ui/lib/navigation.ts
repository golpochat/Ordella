...
export const DASHBOARD_NAV: NavItem[] = [
  ...
  { id: 'event-bus', label: 'Event Bus', href: '/event-bus', icon: Code2 },
  { id: 'globalization', label: 'Globalization', href: '/globalization', icon: Globe },
  { id: 'data-lake', label: 'Data Lake & ETL', href: '/data-lake', icon: Database },
  { id: 'orchestration', label: 'Orchestration', href: '/orchestration', icon: GitBranch },
  { id: 'digital-twins', label: 'Digital Twins', href: '/digital-twins', icon: Layers },
  { id: 'autonomous-retail', label: 'Autonomous Retail', href: '/autonomous-retail', icon: Bot },
...
export const FRANCHISE_HQ_SUBNAV = [
  ...
  { label: 'Supplier Performance', href: '/franchise-hq/supplier-performance' },
